...
from core.utils import format_stage_merge_query, get_table_details_from_schema
...
@with_client
def create_table_from_config_og(dataset_table,
...
@with_client
def create_table_from_schema_config(dataset_table, schema,
                                    # client args
                                    client=None, project_id=None,
                                    # optional overrides
                                    force_recreate=False, confirm_creation=True):
    
    partition_config, clustering, _ = get_table_details_from_schema(schema)
    ...
    create_table(dataset_table, schema,
                 partition_config=partition_config, clustering=clustering,
                 client=client, project_id=project_id)
