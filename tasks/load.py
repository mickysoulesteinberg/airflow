...
from core.bq import create_table_from_config_og
...
@task
def bq_stg_to_final_merge_og(staging_table, final_table,
    ...
    create_table_from_config_og(dataset_table=final_dataset_table, schema_config=schema_config,
...
@task
def create_staging_table_og(schema_config, staging_table=None, final_table=None, dataset=None):
    '''Creates a blank staging table to load data to. Requires confirmation of table creation before returning.'''
    ...
    created_staging_table = create_table_from_config_og(dataset_table=staging_dataset_table, schema_config=schema_config,
